...
module.exports = (function() {
  return {
    ...
    addHome: function(req, res) {
      // console.log(req.body);
      var home = new Home({});
      home.home = req.body.name.toUpperCase()+"'S HOME";
      console.log(home);
      home.save(function(err) {
        if(err) {
          console.log('error', err);
    ...
    resetAllChores: function(req, res) {
      console.log(req.body);
      console.log("incomplete feature");
      // find all users in the home
      // User.find({_home:req.body._id},function(err, users) {
      //   console.log(users);
      //   for(user in users){
      //     users[user].chores = [];
      //   }
      ...
      //     //find each member
      //     for(var member in req.body.families) {
      //       // console.log('member',req.body.families[member]);
      //       //find each chore
      //       for(var chore in req.body.families[member].chores) {
      //         // console.log(req.body.families[member].name, 'chore', req.body.families[member].chores[chore]);
      //         //push each chore into home
      //         home.chores.push(req.body.families[member].chores[chore]);
      //       }
      //     }
      //     console.log('updated homes', home);
